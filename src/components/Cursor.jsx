...
const Cursor = () => {
  ...
  return (
    <>
      ...
      <div 
        className="pointer-events-none fixed top-0 left-0 w-4 h-4 bg-blue-500 rounded-full z-[100] mix-blend-screen transition-transform duration-75 ease-out shadow-[0_0_10px_rgba(37,99,235,0.8)] hidden md:block"
        style={{
